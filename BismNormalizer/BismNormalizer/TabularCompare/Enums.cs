...
namespace BismNormalizer.TabularCompare
{
    ...
    /// </summary>
    public enum ValidationMessageType { Model, DataSource, Table, Column, Relationship, Measure, Kpi, CalculationGroup, CalculationItem, Perspective, Culture, Role, Expression, Action, MeasureCalculationDependency, AggregationDependency, General }; //General used for command line only
    ...
    /// </summary>
    public enum ComparisonObjectType { Model, DataSource, Table, Column, Relationship, Measure, Kpi, CalculationItem, Perspective, Culture, Role, Expression, Action, Connection }; //Need connection for backwards compatibility when deserializing from xml. Set to data source.
